...
lang: pt
hidden: true
title: Esqueça Golden Tickets, Vivendo a era dos Certificados!
...
# Esqueça Golden Tickets, Vivendo a era dos Certificados!
...
- Converter o .pem para pfx com openssl(OPSEC NOTES: Nunca coloque os certificados com uma senha fraca ⚔️).
...
- OPSEC NOTE: Ao gerar certificados com Certipy/fy eles ficarão salvos em "**Issued Certificates**" no **certsrv** dentro da CA, oque dá a possibilidade dos defensores revogarem o seu certificado, oque é um problema. Porém ao utilizar Golden Cerficate você estará gerando os certificados localmente e eles não ficaram salvos dentro do **certsrv**, oque dificultara e MUITO a vida do defensor em revogar o seu certificado 🔥🧑‍🚒.
